            ...
            if filtered_query is None or filtered_query == "":
                ...
                if self.__model == "compute":
                    ...
                    if "Error:" in calc_answer:
                        print("However, when I tried to execute the math, my environment threw an error. I likely lack the specific libraries (like calculus or symbolic algebra) needed to solve this type of equation.")
                    else:
