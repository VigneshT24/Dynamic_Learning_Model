...
print(
    f"\033[31mDLM Bot gets smarter for every query asked because it either knows it or learns it for next time\033[0m")
print(
    f"\033[31mNOTICE: DLM Bot may sometimes misinterpret input or provide inaccurate responses. Please verify important information independently.\033[0m")
...
if (userChoice.lower() == "e"):
    ...
    print("Be aware that the bot can make mistakes, even if it is silly.")
